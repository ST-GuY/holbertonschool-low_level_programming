 ...
 * @f: Pointeur vers une fonction qui prend
 * un char * en paramètre et ne retourne rien.
 ...
 * Cela permet d'utiliser différentes fonctions
 * pour afficher ou manipuler le nom.
 */
