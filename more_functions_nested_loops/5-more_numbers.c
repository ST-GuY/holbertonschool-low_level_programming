 ...
 * les nombres de 0 à 14, dix fois de suite. Si le nombre est supérieur ou égal
 * à 10, elle imprime d'abord le chiffre des dizaines, suivi du chiffre des unités.
